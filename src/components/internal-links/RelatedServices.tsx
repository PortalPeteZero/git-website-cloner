...
const RelatedServices = ({ currentServiceSlug, isSpanish }: RelatedServicesProps) => {
  ...
  const allServices: RelatedService[] = isSpanish ? [
    { title: "Detección de Fugas de Agua", description: "Localice fugas ocultas con imagen térmica y sensores acústicos", href: `${serviceBasePath}/deteccion-fugas-agua` },
    ...
    { title: "Detección Subterránea", description: "Localice tuberías y fugas bajo tierra", href: `${serviceBasePath}/deteccion-subterranea` },
    ...
    { title: "Water Leak Detection", description: "Locate hidden leaks with thermal imaging and acoustic sensors", href: `${serviceBasePath}/water-leak-detection` },
    { title: "Pool Leak Detection", description: "Precise leak detection for pools and spas", href: `${serviceBasePath}/pool-leak-detection` },
    { title: "Underground Detection", description: "Locate pipes and leaks underground", href: `${serviceBasePath}/underground-detection` },
