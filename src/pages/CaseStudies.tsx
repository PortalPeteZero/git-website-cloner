...
const CaseStudies = () => {
  ...
  const caseStudies = isSpanish ? [
    ...
    {
      id: 8,
      title: "Fuga en Villa con Factura de Agua Triplicada",
      location: "Tías",
      description: "Propietario con factura de agua triplicada. Localizamos fuga subterránea en jardín usando gas trazador.",
      fullDescription: "El dueño de una villa en Tías nos contactó tras recibir tres facturas consecutivas de agua mucho más altas de lo normal. Sin signos visibles de humedad en la vivienda, usamos tecnología de gas trazador para rastrear la tubería de riego enterrada en el jardín. Encontramos una junta rota a 1,2m de profundidad bajo una zona de baldosas. La reparación fue rápida y la factura de agua volvió a la normalidad el mes siguiente.",
      result: "Factura de agua reducida un 65% tras la reparación",
      metrics: { time: "3 horas", savings: "€2.400/año" },
      image: photo1,
      imageAlt: "Detección de fuga subterránea con gas trazador villa Tías",
    },
    {
      id: 9,
      title: "Piscina Comunitaria Pierde Agua Cada Noche",
      location: "Puerto del Carmen",
      description: "Comunidad de vecinos reportó pérdida de agua nocturna en piscina. Encontramos fuga en tubería de retorno.",
      fullDescription: "Una comunidad de vecinos en Puerto del Carmen nos llamó porque su piscina perdía varios centímetros de agua cada noche. Después de una prueba de presión en todo el circuito hidráulico, identificamos una fuga en la tubería de retorno enterrada bajo la terraza de la piscina. La reparación dirigida evitó tener que levantar toda la terraza, ahorrando a la comunidad miles de euros en obras innecesarias.",
      result: "Fuga localizada sin levantar la terraza completa",
      metrics: { time: "Medio día", savings: "€6.000+" },
      image: poolLeak1,
      imageAlt: "Detección de fuga en piscina comunitaria Puerto del Carmen",
    },
  ] : [
    {
      id: 1,
    ...
    {
      id: 8,
      title: "Villa Leak Triples Water Bill",
      location: "Tías",
      description: "Homeowner's water bill tripled overnight. We located an underground garden leak using tracer gas.",
      fullDescription: "A villa owner in Tías contacted us after receiving three consecutive water bills far higher than normal. With no visible signs of damp inside the property, we used tracer gas technology to trace the buried irrigation pipe in the garden. We found a broken joint 1.2m deep beneath a tiled patio area. The repair was quick and the water bill returned to normal the following month.",
      result: "Water bill reduced by 65% after repair",
      metrics: { time: "3 hours", savings: "€2,400/year" },
      image: photo1,
      imageAlt: "Underground garden leak detection with tracer gas Tías",
    },
    {
      id: 9,
      title: "Community Pool Losing Water Every Night",
      location: "Puerto del Carmen",
      description: "Residents reported nightly water loss from their communal pool. We found a return pipe leak.",
      fullDescription: "A residents' community in Puerto del Carmen called us because their swimming pool was losing several centimetres of water every night. After pressure testing the entire hydraulic circuit, we identified a leak in the return pipe buried under the pool terrace. The targeted repair avoided having to dig up the entire terrace, saving the community thousands of euros in unnecessary works.",
      result: "Leak located without digging up the entire terrace",
      metrics: { time: "Half day", savings: "€6,000+" },
      image: poolLeak1,
      imageAlt: "Community pool leak detection Puerto del Carmen",
    },
  ];
