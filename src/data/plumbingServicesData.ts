...
export const plumbingServicesData: Record<string, PlumbingService> = {
  ...
  "boiler-services": {
    ...
    metaDescription: "Boiler installation, repair and servicing in Lanzarote. Water heaters, custom outdoor housings, annual maintenance. 2-Year Guarantee.",
    metaDescriptionEs: "Instalación, reparación y mantenimiento de calderas en Lanzarote. Calentadores, carcasas exteriores personalizadas. Garantía 2 años.",
  ...
  "manifold-upgrades": {
    ...
    metaDescriptionEs: "Renovación profesional de colectores en Lanzarote. Reemplazo de válvulas oxidadas y conexiones desgastadas por sistemas modernos de latón. Garantía 2 años.",
  ...
  "pool-repairs": {
    ...
    metaTitle: "Pool Repairs Lanzarote | Pumps & Coatings | Canary Detect",
    metaTitleEs: "Reparaciones Piscinas Lanzarote | Canary Detect",
    metaDescription: "Pool repairs and upgrades in Lanzarote. Shell crack repairs, coatings, pump replacements, heaters and salt chlorinators. 2-Year Guarantee.",
    metaDescriptionEs: "Reparaciones y mejoras profesionales de piscinas en Lanzarote. Grietas del vaso, revestimientos, bombas, calentadores y cloradores salinos. Garantía 2 años.",
    ...
    introText: "Your swimming pool is one of the most valuable features of a Lanzarote property. At Canary Detect, we carry out pool repairs across the island: from minor crack repairs to complete equipment overhauls, pool shell resurfacing, and heating system installations.\n\nAs leak detection specialists, we understand pool systems at a deeper level than most plumbing contractors. We find the root cause of every problem rather than just replacing parts. All repair and upgrade work is backed by our 2-Year Guarantee.",
    introTextEs: "Su piscina es una de las características más valiosas de una propiedad en Lanzarote. En Canary Detect, realizamos reparaciones de piscinas en toda la isla: desde pequeñas reparaciones de grietas hasta renovaciones completas de equipos, resurfacing del vaso e instalaciones de sistemas de calefacción.\n\nComo especialistas en detección de fugas, entendemos los sistemas de piscinas a un nivel más profundo. Todo el trabajo de reparación y mejora está respaldado por nuestra Garantía de 2 Años.",
    richContent: true,
    content: "## Pool Repairs Lanzarote: Shell, Equipment and System Specialists\n\nA swimming pool in Lanzarote is not a luxury item in the way it might be elsewhere in Europe. For many homeowners, it is a key reason for owning the property, and for rental property owners it directly affects rental income and occupancy. When something goes wrong, a slow or incomplete repair is not an option. At Canary Detect, we carry out pool repairs across the island and back every job with a two-year workmanship guarantee.\n\n## Pool Shell Repairs\n\n### Crack Repair in Pool Shells\n\nCracks in pool shells are the most common structural repair we carry out in Lanzarote. They develop over time as a result of ground movement, thermal expansion and contraction, and chemical imbalance in the water. A crack does not always cause a visible water loss straight away. Some allow water to seep slowly into the ground beneath the pool, which shows up as a higher water bill or damp patches appearing around the pool terrace long before the crack becomes visible from inside the pool.\n\nWe repair cracks using structural epoxy compounds that bond permanently to the pool surface, whether it is fibreglass, rendered concrete, or a tiled finish. Structural repairs are carried out with the pool drained to the level of the fault. For minor surface cracks that are not actively losing water, we can often repair them underwater using specialist products that cure without draining.\n\n### Fibreglass Pool Repairs and Refibreglass\n\nFibreglass pools are widespread in Lanzarote, particularly in properties built during the 1990s and 2000s. Over time, fibreglass shells develop osmotic blisters, star cracks around fittings, delamination near the waterline, and surface chalking from the high UV exposure Lanzarote receives. We carry out full fibreglass repair and refinishing: preparing the damaged surface, applying fibreglass laminate layers, sanding, and finishing with a gelcoat or pool paint that closely matches the original colour.\n\nWhere a fibreglass pool has deteriorated to the point where patching is no longer worthwhile, we carry out a complete refibreglass of the shell. This restores the pool to a new condition and eliminates all existing cracks, blisters, and surface defects in a single treatment.\n\n### Pool Painting and Resurfacing\n\nAfter years of use, even a structurally sound pool shell can look tired, stained, or discoloured. Pool painting renews the surface, improves water chemistry stability, and adds years of life to the shell. We use dedicated chlorinated rubber and epoxy pool paints formulated to resist the UV exposure and chemical environment of outdoor pools in Lanzarote.\n\n### ECO Finish Pool Coating\n\nECO Finish is a premium pool coating that provides a smoother and more durable surface than conventional pool paint. Applied as a plastering-type product, it cures to a hard, glass-like surface that resists algae, staining, and chemical erosion. ECO Finish pools are easier to clean, hold water chemistry more consistently, and retain their appearance for longer than painted pools. We are experienced ECO Finish applicators and can advise on whether it is the right choice for your pool.\n\n### Tile and Grout Repairs\n\nPool tiles crack, become loose, or detach due to thermal movement, ground settlement, or deteriorating adhesive behind the tile. Individual tile replacements, waterline tile repairs, and complete retiling of pool steps and ledges are all within our scope. Pool grout deteriorates over time, particularly in areas of high UV exposure. Regrouting prevents water from reaching the structural render beneath the tiles and prolongs the life of the tiling as a whole.\n\n## Pool Equipment Repairs\n\n### Pool Pump Repair and Replacement\n\nThe pump is the heart of any pool filtration system, and a failing pump is the most common pool equipment call we receive across Lanzarote. Pump problems typically show as low flow, noisy operation, air in the system, or the pump failing to prime. We service and repair pump motors, seals, and impellers, and carry out complete pump replacements where repair is no longer economical.\n\nChoosing the right replacement pump matters. An oversized pump wastes electricity and can damage other components in the system. An undersized pump cannot filter the water effectively. We size replacements correctly for the pool volume and pipework, and we recommend variable-speed pumps for owners who want to reduce energy consumption. Variable-speed pumps typically cut pump running costs by 50 to 70 percent compared with single-speed models.\n\n### Pool Heater and Heat Pump Repair and Installation\n\nExtending the swimming season in Lanzarote with a pool heater makes the pool usable for more months of the year. Heat pumps are the most energy-efficient heating option and are now the standard choice for most new installations. We repair heat pump compressors, fans, heat exchangers, and control systems, and carry out complete heat pump installations where an existing heater is beyond economic repair.\n\nWe also install and service gas and electric pool heaters for properties where a heat pump is not suitable, and bypass valve systems that allow the heater to be serviced without draining the pipework.\n\n### Filtration System Repairs and Upgrades\n\nA pool filtration system that is not functioning correctly cannot maintain water quality regardless of the amount of chemical treatment applied. Filter sand replacements, lateral and manifold repairs, multiport valve overhauls, and complete filter replacements are all carried out by our team. We also carry out installation and commissioning of new filter systems where the existing equipment is too small for the pool volume or has reached the end of its service life.\n\n### Salt Chlorinator Repair and Installation\n\nSalt chlorination is the most popular water treatment system for pools in Lanzarote. It produces chlorine automatically from dissolved salt in the pool water, reducing the need for manual chemical dosing and producing a softer, more comfortable swimming environment. Salt chlorinator cells have a typical life of five to eight years, and cell replacement is the most common maintenance item on salt chlorinated pools. We replace cells, repair control boards, and carry out complete salt chlorinator installations on pools currently running on traditional chlorine systems.\n\n## Why Lanzarote Pools Need Specialist Repair Expertise\n\n### Desalinated Water and Scale Build-Up\n\nThe water supply across the Canary Islands comes from desalination plants. Desalinated water has a different mineral profile to mainland European water, and over time it accelerates scale build-up inside heat pump heat exchangers and on the cell plates of salt chlorinators. Equipment servicing intervals for Lanzarote conditions are shorter than manufacturers' standard mainland recommendations. Our team understands this and advises accordingly.\n\n### UV Damage and Salt Air Corrosion\n\nUV radiation levels in Lanzarote are significantly higher than in northern Europe, which accelerates the degradation of pool paints, sealants, and plastic components. Properties close to the coast also experience salt air corrosion on metallic components. Our product and material choices for pool repairs take both of these factors into account.\n\n### Older Pool Installations\n\nA large proportion of Lanzarote's private pools were built in the 1980s and 1990s. Many of these installations have never been fully overhauled and are running on equipment or coatings that are long overdue for renewal. We carry out full condition assessments and can advise on a phased repair and upgrade programme that spreads costs over time rather than requiring everything to be done at once.\n\n## Signs Your Pool Needs Professional Repairs\n\nSeveral signs indicate a pool repair is needed before the problem becomes more serious. Water loss that exceeds normal evaporation, usually more than two centimetres per week in calm, still conditions, suggests a structural crack or pipe leak. Visible cracks in the shell, loose or missing tiles, and bubbling or lifting of the pool coating are clear visual indicators. A pump that runs noisily, fails to prime, or loses pressure over a period of days is a mechanical problem that will worsen if not attended to.\n\nRecurring green water, persistent cloudiness despite correct chemical levels, and unusually high chemical consumption point to a filtration problem. Significantly higher energy bills from the pool equipment can indicate that a pump or heater is running inefficiently and may need servicing or replacement.\n\n## The Pool Repair Process at Canary Detect\n\nWe begin every pool repair job with a full assessment of both the shell and the equipment. Where water loss is a concern, we carry out a leak test before committing to any structural repair, to ensure the source of the problem is correctly identified before any work begins. We then provide a written quote covering the full scope of repair work and the two-year guarantee that applies to everything we do.\n\nRepairs are scheduled to minimise downtime, particularly for properties with rental commitments. Most equipment repairs and minor shell repairs are completed within a day. Larger resurfacing and shell repair projects are planned around the property calendar.\n\n## Frequently Asked Questions: Pool Repairs Lanzarote\n\n### How long do pool repairs take?\n\nMost equipment repairs take one day. Minor shell crack repairs typically take one to two days including curing time. A full pool repaint takes two to three days. A complete refibreglass or ECO Finish resurfacing project takes three to five days. We provide a clear timeline when we give you a quote.\n\n### Will I need to drain my pool for repairs?\n\nNot always. Equipment repairs, salt chlorinator cell replacements, and many tile repairs can be carried out without draining. Structural crack repairs and resurfacing work do require draining to the level of the fault. We carry out pool refills promptly after repair work is complete.\n\n### How much do pool repairs cost in Lanzarote?\n\nCosts depend on the type and extent of the repair. A pump seal replacement costs significantly less than a full pump replacement. A single crack repair costs far less than a complete pool repaint. We provide a clear, itemised quote before any work starts. There are no hidden charges.\n\n### What does the 2-Year Guarantee cover?\n\nOur two-year guarantee covers all workmanship defects. If any repair or installation we have carried out fails within two years as a result of our workmanship, we return at no charge to put it right. The guarantee does not cover damage caused by misuse, chemical imbalance, or third-party interference with our work.\n\n### Do you carry out emergency pool repairs?\n\nYes. If a pool has a major water loss or equipment failure that needs immediate attention, call us and we will prioritise your job. We are based in Lanzarote and can respond quickly across all areas of the island.\n\n### Do you cover pool repairs at holiday rentals and community pools?\n\nYes. We regularly work with holiday rental property owners, property management companies, and community administrators on pool repair and maintenance contracts. We understand the importance of minimising downtime for rental properties and community facilities.",
    services: [
      {
