...
export const plumbingServicesData: Record<string, PlumbingService> = {
  ...
  "boiler-services": {
    ...
    metaDescription: "Professional boiler installation, repair and servicing across Lanzarote. Water heaters, custom outdoor housings, annual maintenance. Fast response. 2-Year Guarantee.",
    metaDescriptionEs: "Instalación, reparación y mantenimiento profesional de calderas en Lanzarote. Calentadores de agua, carcasas exteriores personalizadas. Respuesta rápida. Garantía 2 años.",
  ...
  "pool-repairs": {
    ...
    metaDescription: "Professional pool repairs and upgrades across Lanzarote. Shell crack repairs, protective coatings, pump replacements, heaters and salt chlorinators. 2-Year Guarantee.",
