...
export const plumbingServicesData: Record<string, PlumbingService> = {
  ...
  "pool-repairs": {
    ...
    metaDescription: "Pool repairs & upgrades in Lanzarote. Shell repairs, coatings, pumps, heaters & salt chlorinators. 2-Year Guarantee. Call today.",
    metaDescriptionEs: "Reparaciones de piscinas en Lanzarote. Vaso, bombas, calentadores, cloradores salinos. Garantía 2 años.",
