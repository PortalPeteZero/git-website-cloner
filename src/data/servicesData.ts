...
export const getServicesData = (isSpanish: boolean): Record<string, ServiceData> => {
  ...
  return {
    ...
    "underground-detection": {
      ...
      content: "**Lanzarote's Volcanic Terrain Challenge**\n\nLocating buried pipes and cables in Lanzarote is considerably harder than in conventional mainland soils. The island's subsurface consists of dense basalt layers, loose volcanic gravel (picón), ancient lava flows, and backfill from previous construction. Many properties built during the 1970s, 80s, and 90s lack up-to-date plans, and municipal utility records are often incomplete or non-existent. Without professional detection beforehand, any excavation becomes a costly gamble.\n\n**Ground-Penetrating Radar (GPR): How It Works**\n\nOur ground-penetrating radar emits high-frequency radio pulses that travel into the ground and bounce back when they encounter a material change — such as a pipe, cable, or void. The equipment translates these reflections into a real-time subsurface image. Unlike electromagnetic methods, GPR detects both metallic and non-metallic materials (PVC, polyethylene, fibre cement), which is essential in Lanzarote where modern installations predominantly use plastic. In favourable dry picón conditions, we can reach depths of several metres with good resolution.\n\n**Electromagnetic Location: Metallic vs Non-Metallic**\n\nFor metallic pipes and cables (copper, steel, cast iron), we use precision electromagnetic locators. We connect a transmitter to an accessible point on the metallic pipe, which induces a signal that can be traced from the surface with a handheld receiver. This provides the exact route and estimated depth. Pure plastic pipes are invisible to these devices, which is why we always combine both technologies for a complete survey.\n\n**When You Need This Service**\n\nUnderground detection is essential before:\n\n• Construction work, extensions, or new foundations\n• Swimming pool or hot tub installation\n• Landscaping and garden projects involving deep excavation\n• Locating a [buried water leak](/services/water-leak-detection) between the meter and the house\n• Installing irrigation or drainage systems\n• Route verification before [drain inspections](/services/drain-detection)\n• Buying or selling properties without utility documentation\n\n**What You Receive**\n\nOn completion of the survey, we provide: physical ground marking with spray paint and flags showing routes and depths, a written report with depth measurements and documented routes, a risk assessment for your planned excavation, and recommendations on safe digging zones. This documentation protects your investment and simplifies any future work on the property.",
    },
    "water-leak-detection": {
    ...
    "leak-repair": {
      ...
      features: [
        "Water mains & supply pipe repair",
        "Internal pipe repairs",
        "Pool pipework repair",
        "Underground leak repair",
        "Drain connection repair",
        "Emergency 24/7 callout",
      ],
      richContent: true,
      content: "**Five Types of Leaks We Repair**\n\nCanary Detect handles every category of water leak found across Lanzarote properties. We repair **water mains and supply pipes** from the meter to the building, **internal pipes** within walls, floors and ceilings, **pool pipework** including pump-room manifolds and return lines, **underground pipes** buried beneath driveways, gardens and terraces, and **drain connections** where waste pipes join the main sewer or septic system. Whatever the source, we carry the materials and expertise to fix it on site.\n\n**Our 5-Step Repair Process**\n\nEvery repair follows a structured workflow so nothing is left to chance:\n\n1. **Detection first** — we use our specialist equipment to pinpoint the exact leak location before any ground is opened. If you haven't had a survey yet, start with our [water leak detection service](/services/water-leak-detection).\n2. **Targeted excavation** — we open only the minimum area needed, protecting tiles, landscaping and pool surrounds wherever possible.\n3. **Repair** — the damaged section is cut out and replaced using the correct material and method for the pipe type (see below).\n4. **Pressure test** — we pressurise the repaired section to confirm it holds before closing up.\n5. **Reinstatement** — excavations are backfilled, compacted and finished so the area is left tidy and safe.\n\n**Lanzarote-Specific Challenges**\n\nRepairing leaks on this island is harder than on the mainland. The volcanic rock (basalt and compacted picón) makes access difficult and often requires specialist cutting equipment rather than standard digging. Many older properties built in the 1970s and 1980s still have **corroded galvanised steel pipes** that crumble when disturbed, meaning a simple repair can reveal a much larger replacement need. UV exposure from the intense Canary Island sun degrades exposed plastic fittings and rubber seals far faster than in northern Europe, leading to premature joint failures on roof terraces and exterior pump rooms.\n\n**Materials and Techniques**\n\nWe select the repair method to match the pipe material and location:\n\n• **Solvent-weld PVC** — the standard for new pool and waste pipework, providing a permanent chemical bond.\n• **Compression fittings** — used on polyethylene (PE) mains supply pipes where flexibility is needed.\n• **Epoxy injection** — ideal for hairline cracks in concrete pool shells or rendered channels without excavation.\n• **Pipe relining** — for drain pipes where access is restricted, we insert a resin-impregnated liner that cures in place, creating a new pipe inside the old one.\n\nAll materials are rated for outdoor UV exposure and the mineral-rich desalinated water supply used across Lanzarote.\n\n**Emergency vs Planned Repairs**\n\nFor **active leaks** causing visible water loss, rising damp or water-bill spikes, we offer a **24/7 emergency callout** service across the island. Our team aims to attend within hours, isolate the supply if needed, and carry out a same-day repair.\n\nFor **slow or suspected leaks** — such as a gradually dropping pool level or a minor damp patch — we schedule a convenient appointment, often combining the repair visit with a [pool leak detection survey](/services/pool-leak-detection) or [underground pipe trace](/services/underground-detection) to confirm the source first.\n\n**12-Month Guarantee**\n\nEvery repair carried out by Canary Detect is backed by our **12-month workmanship guarantee**. If the same joint or section fails within that period, we return and fix it at no additional cost. We also provide a written report detailing the repair location, method and materials used — useful for insurance claims and future property records.",
    },
    "drain-unblocking": {
